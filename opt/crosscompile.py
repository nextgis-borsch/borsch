...
repositories = [
    ...
    {"name": "nextgis_datastore", "args" : ['-DWITH_OpenSSL=ON', '-DWITH_OpenSSL_EXTERNAL=ON', '-DWITH_GEOS=ON', '-DWITH_GEOS_EXTERNAL=ON', '-DWITH_GDAL=ON', '-DWITH_GDAL_EXTERNAL=ON', '-DBUILD_TESTS=OFF', '-DWITH_SQLite3_EXTERNAL=ON']},
]
