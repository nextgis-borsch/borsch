...
repositories = [
    ...
    {"name": "lib_tiff", "args" : ['-DWITH_ZLIB=ON', '-DWITH_JPEG_EXTERNAL=ON', '-DWITH_JBIG_EXTERNAL=ON', '-DWITH_LibLZMA_EXTERNAL=ON', '-DWITH_JPEG=ON', '-DWITH_JBIG=ON', '-DWITH_LibLZMA=ON', '-DBUILD_TOOLS=ON', '-DSKIP_BUILD_DOCS=ON', '-DBUILD_TESTING=OFF']},
    ...
    {"name": "lib_hdf4", "args" : ['-DWITH_ZLIB=ON', '-DWITH_JPEG=ON', '-DWITH_JPEG_EXTERNAL=ON', '-DWITH_SZIP=ON', '-DWITH_SZIP_EXTERNAL=ON', '-DBUILD_TESTING=OFF']},
